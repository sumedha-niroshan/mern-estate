...
export default function Search() {
  ...
  useEffect(() => {
    ...
    const searchTerFrommUrl = urlParams.get("searchTerm");
    const typeFrommUrl = urlParams.get("type");
    ...
    if (
      ...
      setSidebardata({
        searchTerm: searchTerFrommUrl || "",
        type: typeFrommUrl || "all",
        ...
        <div className="p-7 flex gap-4 flex-wrap">
          ...
          {showMore && (
            <button
              ...
              className="text-green-700 underline p-7 text-center w-full"
            >
              Show more
            </button>
          )}
